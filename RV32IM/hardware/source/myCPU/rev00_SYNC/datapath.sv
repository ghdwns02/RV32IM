module datapath(
    ...
    wire            div_start = is_div_in_EX & ~div_done;

    wire            MDUStall  = is_div_in_EX & ~div_done;
    wire            Stall_all = Stall | MDUStall;

    wire    [31:0]  ALUResultFinal = (is_div_in_EX & div_done) ? div_result : ALUResult;

    wire    [31:0]  ALUResultM_eff = is_mul_in_MEM ? mul_result : ALUResultM;
