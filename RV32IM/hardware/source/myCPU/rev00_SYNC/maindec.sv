module maindec(
    ...
    always@(*) begin
        case(opcode)
            ...
            7'b111_0011 : {RegWrite, ImmSrc, ALUSrcA, ALUSrcB, MemWrite, ResultSrc, Branch, ALUop} = 13'b1_101_00_0000_000;
            default : {RegWrite, ImmSrc, ALUSrcA, ALUSrcB, MemWrite, ResultSrc, Branch, ALUop} = 13'h0;
        endcase
    end
