// div_unit.sv
// Wraps Vivado Divider Generator IP (div_gen_0):
//   Radix-2, Unsigned, Dividend 33-bit, Divisor 32-bit, Remainder, Detect-Divide-By-Zero
// Handles RISC-V signed/unsigned DIV/REM, exception cases (div-by-zero, signed overflow).
// External interface is identical to the original RTL-only div_unit.
